...
namespace FEXNA_Library.Chapters
{
    ...
    {
        readonly static string[] RANKS = new string[] { "SS", "S", "A", "B", "C" };
        readonly static int[] RANK_SCORES = new int[] { 450, 200, 125, 50 };
        ...
        public int OutOfTurns { get { return Chapter.Ranking_Turns + 10; } }
        public int OutOfCombat { get { return Chapter.Ranking_Combat + 100; } }
        public int OutOfExp { get { return Chapter.Ranking_Exp - 1000; } }
        public int OutOfCompletion { get { return Chapter.Ranking_Completion - 10; } }
        ...
        public int Score
        {
            get
            {
                return Turns + Combat + Exp + Completion;
            }
        }
