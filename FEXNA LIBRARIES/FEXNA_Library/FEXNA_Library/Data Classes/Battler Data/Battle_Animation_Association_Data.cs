...
namespace FEXNA_Library.Battler
{
    ...
    public class Battle_Animation_Association_Data
    {
        ...
        //public Dictionary<AttackAnims, List<int>> AttackAnimations = new Dictionary<AttackAnims, List<int>>(); //Debug
        ...
        public static Battle_Animation_Association_Data Read(BinaryReader input)
        {
        ...
        public Battle_Animation_Association_Data(Battle_Animation_Association_Data other)
        {
            Idle = new List<int>(other.Idle);
            Avoid = new List<int>(other.Avoid);
            AvoidReturn = new List<int>(other.AvoidReturn);
            GetHit = new List<int>(other.GetHit);
            GetCrit = new List<int>(other.GetCrit);
            Dance = new List<int>(other.Dance);
            DanceHold = new List<int>(other.DanceHold);
            DanceReturn = new List<int>(other.DanceReturn);
            PreFight = new List<int>(other.PreFight);
