...
namespace FEXNA_Library
{
    public class Data_Tileset : IFEXNADataContent
    {
        ...
        public Data_Tileset(Data_Tileset tileset)
        {
            Id = tileset.Id;
            Name = tileset.Name;
            Graphic_Name = tileset.Graphic_Name;
            BattlebackSuffix = tileset.BattlebackSuffix;
            Animated_Tile_Names = new List<string>(tileset.Animated_Tile_Names);
            Animated_Tile_Data = new List<Rectangle>(tileset.Animated_Tile_Data);
            Pillage_Tile_Changes = new Dictionary<Vector2, Vector2>(tileset.Pillage_Tile_Changes);
            Terrain_Tags = new List<int>(tileset.Terrain_Tags);
        }
