...
namespace FEXNA.IO
{
    internal class Save_Data
    {
        ...
        {
            return string.Format("Save_Data: {0}, {1}, {2}", Chapter_Id,
                System.Difficulty_Mode, System.Style);
        }
        ...
        public void load_data()
        {
            ...
            Global.game_system.set_event_data(Switches, Variables);
