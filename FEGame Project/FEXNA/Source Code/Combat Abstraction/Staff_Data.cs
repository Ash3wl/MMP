...
namespace FEXNA
{
    ...
    class Staff_Data : Combat_Data
    {
        ...
        protected override void set_variables(Game_Unit battler_1, Destroyable_Object battler_2)
        {
            base.set_variables(battler_1, battler_2);
            Mode = get_staff_mode(Weapon_1_Id);
        }
        ...
        public override void apply_combat(bool immediate_level, bool skip_exp)
        {
            ...
            if (Battler_2_Id != null)
            {
                ...
                {
                    // needs to account for Fortify //Debug
                    Global.game_map.units[Battler_1_Id].actor.heal_support_gain(Global.game_map.units[(int)Battler_2_Id].actor.id);
                    Global.game_map.units[(int)Battler_2_Id].actor.heal_support_gain(Global.game_map.units[Battler_1_Id].actor.id);
                }
...
#endif
                Global.game_map.units[(int)Battler_2_Id].staff_effect(this.weapon1, -1);
            }
        }
    }
}