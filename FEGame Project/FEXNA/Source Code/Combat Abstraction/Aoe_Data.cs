    ...
    class Aoe_Data : Combat_Data
    {
        ...
        protected override void setup()
        {
            ...
            for (int i = 0; i < Battler_2_Ids.Count; i++)
            {
                ...
                process_attacks(battler_1, battler_2); // why was there a breakpoint here? //Test
        ...
        public override void apply_combat(bool immediate_level, bool skip_exp)
        {
            ...
            for (int i = 0; i < Data.Count; i++)
            {
                ...
                data.cause_damage(Battler_1_Id, Battler_2_Ids[i]);
            }
            ...
            if (Constants.Combat.AOE_WEXP_GAIN)
                if (Wexp1 > 0)
                {
                    FEXNA_Library.WeaponType type = Global.data_weapons[Weapon_1_Id].main_type();
        ...
        new public bool is_ally_killed
        {
            get
            {
                if (Kill != 0)
        ...
        new public bool has_death_quote
        {
            get
            {
                if (Kill != 0)
