...
namespace FEXNA
{
    class Terrain_Attack_Data : Combat_Data
    {
        ...
        protected override void setup()
        {
            ...
            Destroyable_Object target = Global.game_map.destroyable_objects[(int)Battler_2_Id];
            ...
            Data[Data.Count - 1].Key.end_battle(battler_1, target, Distance, Data[Data.Count - 1].Value);
        ...
        public override void apply_combat(bool immediate_level, bool skip_exp)
        {
            ...
            Game_Unit battler_1 = Global.game_map.units[Battler_1_Id];
            Destroyable_Object battler_2 = Global.game_map.destroyable_objects[(int)Battler_2_Id];
