    ...
    class Scripted_Combat_Data : Combat_Data
    {
                    ...
                    while (!cont)
                    {
                        ...
                        if (attacker > 0)
                        {
                            if (battler_2 == null)
                                ...
                                add_attack(battler_1, battler_2 as Destroyable_Object, attacker);
                        }
                    }
                }
            }
        ...
        protected void add_attack(Game_Unit battler_1, Game_Unit battler_2, Scripted_Combat_Stats stats)
        {
            ...
            if (stats.Attacker == 1)
                ...
                Attacked_2 = true;
            Data[Data.Count - 1].Key.set_attack(battler_1, battler_2, Distance, Data[Data.Count - 1].Value, stats);
            // Add Attacks
        ...
        protected override void end_battle(Game_Unit battler_1, Combat_Map_Object battler_2)
        {
            if (Global.game_temp.scripted_battle_stats != null)
                Data[Data.Count - 1].Key.end_battle(battler_1, battler_2,
                    Global.game_temp.scripted_battle_stats.Stats.Last(), Data[Data.Count - 1].Value);
            else
                base.end_battle(battler_1, battler_2);
        }
