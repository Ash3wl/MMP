...
namespace FEXNA
{
    partial class Scene_Map
    {
        ...
        protected virtual void create_wlvl_popup(int weapon)
        {
            WLvl_Popup = new Weapon_Level_Popup(weapon, false);
            WLvl_Popup.loc = new Vector2(92, 80);
        }
                    ...
                    switch (WLvl_Action)
                    {
                        case 0:
                            switch (WLvl_Timer)
                            {
                                ...
                                case 18:
                                    Global.Audio.play_se("System Sounds", "Gain");
                                    create_wlvl_popup(Global.game_map.units[WLvl_Battler_Id].actor.wlvl_up_type());
                                    WLvl_Action = 1;
                                    WLvl_Timer = 0;
                                    break;
                            }
                        ...
                        case 0:
                            switch (WBreak_Timer)
                            {
                                ...
                                case 17:
                                    ...
                                    break;
                                case 18:
                                    Global.Audio.play_se("System Sounds", "Loss");
                                    create_wbreak_popup();
                                    WBreak_Action = 1;
                                    WBreak_Timer = 0;
                                    break;
