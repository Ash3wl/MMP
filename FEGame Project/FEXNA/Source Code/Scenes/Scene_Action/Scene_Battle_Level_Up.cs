...
namespace FEXNA
{
    partial class Scene_Action
    {
        ...
        {
            if (!Promoting && (Scene_Type == "Scene_Arena" || Scene_Type == "Scene_Battle" || Scene_Type == "Scene_Staff"))
            {
                switch (Level_Up_Timer)
                {
                    case 0:
        ...
        {
            if (Scene_Type == "Scene_Arena" || Scene_Type == "Scene_Battle" || Scene_Type == "Scene_Staff")
            {
                switch (Level_Up_Timer)
                {
                    case 0:
