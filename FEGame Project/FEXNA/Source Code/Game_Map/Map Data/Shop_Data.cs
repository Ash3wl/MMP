...
namespace FEXNA.Map
{
    internal class Shop_Data
    {
        ...
        public List<FEXNA_Library.Item_Data> items { get { return Items; } }
        #endregion
        ...
        public void add_item(FEXNA_Library.Item_Data item)
        {
            Items.Add(item);
        }
        public void add_items(IEnumerable<FEXNA_Library.Item_Data> items)
        {
