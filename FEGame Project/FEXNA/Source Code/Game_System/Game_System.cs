...
namespace FEXNA
{
    internal partial class Game_System
    {
        ...
        internal Animation_Modes Battle_Mode;
        ...
        protected string Chapter_Id, Previous_Chapter_Id;
        protected int Total_Play_Time, Chapter_Play_Time;
        protected DateTime Chapter_Start_Time;
        ...
        public void write(BinaryWriter writer)
        {
            ...
            writer.Write(Previous_Chapter_Id);
        ...
        public void read(BinaryReader reader)
        {
            ...
            if (Global.LOADED_VERSION.older_than(0, 4, 3, 2))
            {
            ...
            if (!Global.LOADED_VERSION.older_than(0, 5, 5, 4))
            {
                SupportGainId = reader.ReadInt32();
                SupportGainTargets.read(reader);
            }

            Battle_Mode = (Animation_Modes)reader.ReadInt32();
            ...
            if (!Global.LOADED_VERSION.older_than(0, 4, 4, 0))
            {
                ...
                Previous_Chapter_Id = reader.ReadString();
            }
            Total_Play_Time = reader.ReadInt32();
            Chapter_Play_Time = reader.ReadInt32();
            if (!Global.LOADED_VERSION.older_than(0, 4, 6, 3))
            {
            ...
            if (!Global.LOADED_VERSION.older_than(0, 4, 4, 3))
        ...
        internal void set_event_data(Event_Variable_Data<bool> switches, Event_Variable_Data<int> variables)
        {
            Event_Variable_Data<bool>.copy(switches, SWITCHES);
            Event_Variable_Data<int>.copy(variables, VARIABLES);
        }
        ...
        /// <summary>
        /// Actor ids of characters that the player must keep alive this chapter.
        /// </summary>
        public HashSet<int> loss_on_death { get { return Loss_On_Death; } }
        /// <summary>
        /// Actor ids of characters that the player must keep alive this chapter, if the characters are on the player team.
        /// </summary>
        public List<int> ally_loss_on_death
        {
            get
            {
        ...
        public string previous_chapter_id { get { return Previous_Chapter_Id; } }
        ...
        public void reset()
        {
            ...
            Battle_Mode = Animation_Modes.Map;
            Status_Page = 0;
            Unit_Page = 0;
            Unit_Sort = 0;
            Unit_Sort_Up = true;
        ...
        public void new_chapter(List<string> previous_chapters, string chapter_id, string previous_chapter_id)
        {
        ...
        internal void update_victory()
        {
            ...
            if (!Failure && !Preparations && Global.map_exists)
            {
                ...
                foreach (int actor_id in ally_loss_on_death) // This is only supposed to check player units //Yeti
                {
                    if (Global.game_map.actor_defeated(actor_id))
                    {
                        Failure = true;
            ...
            int killed_enemies, int enemies_remaining)
        {
            ...
            return new Game_Ranking(chapter.Id, turn_to_clear, damage_on_clear, exp_on_clear, Chapter_Deaths, Chapter_Completion);
        }
