...
namespace FEXNA
{
    class FE_Battler_Image_Wrapper
    {
        ...
        {
            return Global.animation_group(string.Format("{0}-{1}",
        ...
        /// </summary>
        internal static List<int> spell_attack_animation_value(int weapon_id, int distance, bool hit)
        {
            int offset = Global.animation_group("Spells");
            return FE_Battler_Image.spell_attack_animation_value(weapon_id, offset, distance, hit);
        }

        /// <summary>
        /// Returns the animation numbers of the given spell's start up, played behind characters but above platform
        /// </summary>
        internal static List<int> spell_attack_animation_value_bg1(int weapon_id, int distance, bool hit)
        {
            int offset = Global.animation_group("Spells");
            return FE_Battler_Image.spell_attack_animation_value_bg1(weapon_id, offset, distance, hit);
        }

        /// <summary>
        /// Returns the animation numbers of the given spell's start up, played behind the platform
        /// </summary>
        internal static List<int> spell_attack_animation_value_bg2(int weapon_id, int distance, bool hit)
        {
            int offset = Global.animation_group("Spells");
            return FE_Battler_Image.spell_attack_animation_value_bg2(weapon_id, offset, distance, hit);
        }

        /// <summary>
        /// Returns the animation numbers of the given spell's start up, played above the HUD
        /// </summary>
        internal static List<int> spell_attack_animation_value_fg(int weapon_id, int distance, bool hit)
        {
            int offset = Global.animation_group("Spells");
            return FE_Battler_Image.spell_attack_animation_value_fg(weapon_id, offset, distance, hit);
        }

        /// <summary>
        /// Returns the animation numbers of the given spell's ending
        /// </summary>
        internal static List<int> spell_end_animation_value(int weapon_id, bool hit)
        {
            int offset = Global.animation_group("Spells");
            return FE_Battler_Image.spell_end_animation_value(weapon_id, offset, hit);
        }

        /// <summary>
        /// Returns the animation numbers of the given spell's life drain effect, after hit but before recovery
        /// </summary>
        internal static List<int> spell_lifedrain_animation_value(int weapon_id, int distance)
        {
            int offset = Global.animation_group("Spells");
            return FE_Battler_Image.spell_lifedrain_animation_value(weapon_id, offset, distance);
        }
        /// <summary>
        /// Returns the animation numbers of the given spell's life drain effect, starts at the same time as recovery
        /// </summary>
        internal static List<int> spell_lifedrain_end_animation_value(int weapon_id)
        {
            int offset = Global.animation_group("Spells");
            return FE_Battler_Image.spell_lifedrain_end_animation_value(weapon_id, offset);
        }
        #endregion
    ...
    class Animation_Setup_Data_Processor : Animation_Setup_Data
    {
        public Animation_Setup_Data_Processor(Game_Unit battler, int distance)
        {
            ...
            Adept_Activated = battler.actor.adeptActivated;
            Astraaa_Activated = battler.actor.astraaaActivated;
            Adept_Count = battler.actor.adeptCount;
        }
    }
}
