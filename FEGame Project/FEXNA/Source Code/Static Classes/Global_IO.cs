...
namespace FEXNA
{
    public static partial class Global
    {
        ...
        // Load Suspend
        static bool Load_Suspend = false;
        public static bool loading_suspend
        {
            get { return Load_Suspend; }
            set { Load_Suspend = value; }
        }
        ...
        // Save/load suspend
        public static void save_suspend(BinaryWriter writer, int fileId)
        {
            ...
            FEXNA.IO.Suspend_Info.get_suspend_info(fileId).write(writer);
            /* Call Serialize */
            ...
            Version v, Version oldestAllowedVersion)
        {
            ...
            {
                load_v_0_4_7_0(reader, out fileId);
                return true;
            }
        ...
        private static void load_v_0_4_7_0(BinaryReader reader, out int fileId)
        {
