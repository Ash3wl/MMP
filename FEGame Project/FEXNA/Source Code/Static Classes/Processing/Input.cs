...
namespace FEXNA
{
    ...
    public class Input
    {
        ...
        public static void default_keys()
        {
            ...
            key_redirect.Add((int)Inputs.A, Keys.Z); //wark YETI PLS
            key_redirect.Add((int)Inputs.B, Keys.X);
        ...
        private static void update_buttons(KeyboardState key_state, GamePadState controller_state, float left_stick_angle)
        {
            // Loop through inputs
