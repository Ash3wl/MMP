    ...
    public class Character_Hp_Gauge : Matrix_Position_Sprite
    {
        ...
        internal void update(Game_Unit unit)
        {
                ...
                HpGaugesMode != Global.game_options.hp_gauges)
            {
                ...
                float hue;
                // Simple mode
                if (HpGaugesMode == (int)Hp_Gauge_Modes.Basic)
            ...
            Team = unit.team;
            visible = Global.game_options.hp_gauges != (int)Hp_Gauge_Modes.Injured ||
                !actor.is_full_hp();
        }
        ...
        public override void draw(SpriteBatch sprite_batch, Vector2 draw_offset, Matrix matrix)
        {
            if (texture != null)
                if (visible)
                {
                    ...
                    // Simple mode
                    if (Global.game_options.hp_gauges == (int)Hp_Gauge_Modes.Basic)
                    {
