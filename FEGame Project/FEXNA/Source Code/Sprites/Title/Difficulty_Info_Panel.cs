...
namespace FEXNA
{
    class Difficulty_Info_Panel : Title_Info_Panel
    {
        ...
        public Difficulty_Info_Panel(Difficulty_Modes difficulty)
        {
            ...
            Size = new Vector2(WIDTH, Window.height - 8);

            Difficulty = new FE_Text();
            Difficulty.loc = new Vector2(8, 0);
            ...
            Description.loc = new Vector2(0, 16);
        ...
        {
            Vector2 loc = draw_offset - (this.loc + this.draw_offset + stereo_offset());
