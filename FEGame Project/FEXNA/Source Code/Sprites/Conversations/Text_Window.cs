...
namespace FEXNA
{
    public class Text_Window : Text_Box
    {
        ...
        public string text_color
        {
            set
            {
                if (Global.content_exists(@"Graphics/Fonts/FE7_Convo_" + value))
                {
                    Color = value;
                    if (Text_Imgs.Any())
                        Text_Imgs[Text_Imgs.Count - 1].text_colors[Text_Imgs[Text_Imgs.Count - 1].text.Length] = "FE7_Convo_" + Color;
                }
            }
        }
        #endregion
        ...
        public void text_clear()
        {
            ...
            Text_Imgs[0].Font = "FE7_Convo";
            Text_Imgs[0].text_colors[0] = "FE7_Convo_" + Color;
        }
        ...
        public void add_line()
        {
            ...
            {
                if (Text_Imgs[i].loc.Y <= -16)
                    Text_Imgs.RemoveAt(i);
                else
                    i++;
            }
            Text_Imgs.Add(new FE_Text());
            Text_Imgs[Text_Imgs.Count - 1].Font = "FE7_Convo";
            Text_Imgs[Text_Imgs.Count - 1].text_colors[0] = "FE7_Convo_" + Color;
            Text_Imgs[Text_Imgs.Count - 1].loc = Text_Imgs[Text_Imgs.Count - 2].loc + new Vector2(0, 16);
        }
