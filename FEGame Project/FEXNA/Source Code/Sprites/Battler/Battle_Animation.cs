    ...
    class Battle_Animation : Sprite
    {
        ...
        protected void update_sounds()
        {
            ...
            foreach (string name in sound_names)
            {
                ...
                else if (name == "Stop_BGM")
                {
                    Global.Audio.set_bgm_volume(0);
                }
                else if (name == "Start_BGM")
                {
                    Global.Audio.set_bgm_volume(Global.game_options.music_volume);
                }
                ...
                //wark HERES THE THING
                else if (name == "MarcAtk")
                {
                    marc_voice = Global.game_system.get_rng();
                    marc_voice /= 4;
                    marc_voice++;
                    Global.Audio.play_se("Battle Sounds", "atk" + marc_voice);
                }
                else if (name == "MarcRet")
                {
                    marc_voice = Global.game_system.get_rng();
                    marc_voice = (int)(marc_voice / 5.55f);
                    Global.Audio.play_se("Battle Sounds", "ret" + marc_voice);
                }
                else if (name == "MarcHit")
                {
                    marc_voice = Global.game_system.get_rng();
                    marc_voice = (int)(marc_voice / 6.66f);
                    marc_voice++;
                    if(marc_voice < 4)
                        Global.Audio.play_se("Battle Sounds", "mHit" + marc_voice);
                    else
                        Global.Audio.play_se("Battle Sounds", "hit" + marc_voice);
                }
                else if (name == "MarcAvo")
                {
                    marc_voice = Global.game_system.get_rng();
                    marc_voice = (int)(marc_voice / 8.33f);
                    marc_voice++;
                    Global.Audio.play_se("Battle Sounds", "avo" + marc_voice);
                }
                else if (name == "MarcCrit")
                {
                    marc_voice = Global.game_system.get_rng();
                    marc_voice = (int)(marc_voice / 12.5f);
                    marc_voice++;
                    Global.Audio.play_se("Battle Sounds", "crit" + marc_voice);
                }
                else if (name == "MarcZiti")
                {
                    marc_voice = Global.game_system.get_rng();
                    marc_voice /= 25;
                    marc_voice++;
                    Global.Audio.play_se("Battle Sounds", "skl" + marc_voice);
                }
                else
                    Global.Audio.play_se("Battle Sounds", name);
            }
