...
namespace FEXNA.Windows.Target
{
    class Window_Target_Rescue : Window_Target_Unit
    {
        ...
        protected void initialize_images()
        {
            ...
            Aid_Label.draw_offset = new Vector2(8, 24 + (mode != 3 ? 0 : 48));
            ...
            Con_Label.draw_offset = new Vector2(8, 24 + (mode == 3 ? 0 : 48));
            ...
            Aid_Value.draw_offset = new Vector2(72, 24 + (mode != 3 ? 0 : 48));
            ...
            Con_Value.draw_offset = new Vector2(72, 24 + (mode == 3 ? 0 : 48));
        ...
        {
            Game_Unit unit = null, target = null;
            ...
            switch (mode)
            {
                ...
                default:
                    unit = get_unit();
                    target = Global.game_map.units[this.target];
                ...
                // Give
                case 3:
                    unit = Global.game_map.units[this.target];
