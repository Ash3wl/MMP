...
namespace FEXNA.Windows.Target
{
    internal class Window_Target_Combat : Window_Target_Unit
    {
        ...
        public Window_Target_Combat(int unit_id, int item_index, Vector2 loc)
        {
            initialize(loc);
            Unit_Id = unit_id;
        ...
        protected List<int> get_targets(int item_index)
        {
            ...
            // Skills: Trample
                ...
                return unit.enemies_in_range(new HashSet<Vector2> { unit.loc }, item_index)[0];
        }
        ...
        protected override void set_images()
        {
            ...
            {
                Window.team2 = Constants.Map.DESTROYABLE_OBJECT_TEAM;
            }
            ...
            string name2 = is_target_unit ? actor2.name : ((Destroyable_Object)target).name;
