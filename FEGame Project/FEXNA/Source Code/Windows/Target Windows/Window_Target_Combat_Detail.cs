...
namespace FEXNA.Windows.Target
{
    class Window_Target_Combat_Detail : Window_Target_Combat
    {
        ...
        public Window_Target_Combat_Detail(int unit_id, int item_index, Vector2 loc) : base(unit_id, item_index, loc) { }
        ...
        protected override void set_images()
        {
            ...
            if (this.skills_visible)
            {
                for (int i = base.stat_rows * 2; i < stat_rows * 2; i++)
                {
                        ...
                        (i % 2 == 0 ? unit : target_unit).has_any_mastery() != null)
                    {
                        ...
                        gauge.height = 4;
                        Stats.Add(gauge);
                        gauge.draw_offset = new Vector2(48 - (48 * (i % 2)), -8 + ((i / 2 + 1) * LINE_HEIGHT));
                    }
                    else
                    {
            ...
            if (is_target_unit)
            {
                ...
                // Terrain avo
                var avo = unit.terrain_avo_bonus(target_unit);
            ...
            if (is_target_unit)
            {
                ...
                // Terrain avo
                var avo = target_unit.terrain_avo_bonus(unit);
