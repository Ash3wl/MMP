...
namespace FEXNA
{
    enum Shop_Messages { Intro, Question, Buy, Buy_Confirm, Buy_Else, Buy_Not_Enough, Buy_Nothing, Buy_Full, Buy_No_Merchant,
        Sell, Sell_Confirm, Sell_Else, Sell_Cant_Buy, Sell_Nothing, Anything_Else, Leave, Cancel,
