...
namespace FEXNA
{
    ...
    class Window_Arena : Window_Business
    {
        ...
        private void generate_opponent()
        {
            ...
            {
                if (!opponent.actor.actor_class.is_equippable(Global.data_weapons[id]))
                    break;
                opponent.actor.items[0] = new Item_Data(0, id, 100);
                weapon_id = id;
        ...
        private void rebalance_arena_fight()
        {
            ...
            var opponent_stats = new CombatStats(
        ...
        protected override void play_shop_theme()
        {
            ...
            Global.Audio.play_bgm(Shop.song);
        }
