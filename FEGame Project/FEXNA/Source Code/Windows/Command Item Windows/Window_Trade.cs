...
namespace FEXNA.Windows.Command
{
    class Window_Trade : Stereoscopic_Graphic_Object, ISelectionMenu
    {
        ...
        private void item_node(int unit_index, int index, List<CommandUINode> nodes)
        {
            ...
            FEXNA_Library.Item_Data item_data = unit_index == 0 ? actor1.items[index] : actor2.items[index];
        ...
        private FEXNA_Library.Item_Data item_data()
        {
            ...
            return (this.column == 0 ? actor1.items[this.index] : actor2.items[this.index]);
        }
        ...
        public bool enter()
        {
            ...
            else
            {
                ...
                FEXNA_Library.Item_Data item_data1 = actor1.items[index1];
                FEXNA_Library.Item_Data item_data2 = actor2.items[index2];
                actor1.items[index1] = item_data2;
                actor2.items[index2] = item_data1;

                this.actor1.sort_items();
                this.actor2.sort_items();
                Global.game_system.play_se(System_Sounds.Confirm);
                cancel();
                return true;
            }
