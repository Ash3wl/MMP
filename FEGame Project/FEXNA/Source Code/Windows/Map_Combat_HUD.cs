    ...
    class Map_Combat_HUD : Sprite
    {
        ...
        protected Combat_Map_Object unit_2
        {
            get
            {
                ...
                else if (Data != null && Data.type == "Aoe")
                    return Global.game_map.attackable_map_object((int)((Aoe_Data)Data).Battler_2_Ids[Math.Max(0, Attack_Id)]);
                return null;
            }
        }
        ...
        protected int team2
        {
            get
            {
                return unit_2.is_unit() ?
                    ((Game_Unit)unit_2).team : Constants.Map.DESTROYABLE_OBJECT_TEAM;
            }
        }
        #endregion
