...
namespace FEXNA
{
    internal partial class Game_State
    {
        ...
        internal void call_aoe(int id1, List<int> targets)
        {
            Global.game_system.Battler_1_Id = id1;
        ...
        internal void call_staff(int id1, int id2, Maybe<Vector2> target_loc = default(Maybe<Vector2>))
        {
        ...
        internal bool support_active { get { return SupportState.support_calling || SupportState.in_support ||
