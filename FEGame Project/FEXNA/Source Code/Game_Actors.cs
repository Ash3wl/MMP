...
namespace FEXNA
{
    internal class Game_Actors
    {
        ...
        {
            return get_map_sprite_name(Global.data_classes[actor.ClassId].Name, actor.ClassId, actor.Gender);
        }
        ...
        public static string class_map_sprite_name(
            ...
            bool moving)
        {
            string name = class_map_sprite_name(className, gender);
            ...
            bool moving)
        {
            ...
            {
                name = Scene_Map.DEFAULT_MAP_SPRITE + (name.Substring(name.Length - 5, 5) == "_move" ? "_move" : "");
            }
            return name;
        }
