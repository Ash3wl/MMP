...
namespace FEXNA
{
    public class Map_Animations
    {
            ...
            new Dictionary<int, Map_Effect_Data>
        {
            ...
            #endregion
            #region 10: Warp
            { 10, new Map_Effect_Data { image = new KeyValuePair<string, int>("Warp", 1),//wark
                animation_data = new List<KeyValuePair<int[], int>>
                    {
                        new KeyValuePair<int[], int>(new int[] { 0, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 1, 255, 255 }, 2),
                        ...
                        new KeyValuePair<int[], int>(new int[] { 15, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 16, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 17, 0, 255 }, 33)
                    },
                    processing_data = new List<KeyValuePair<int,string[]>>
                    {
                        new KeyValuePair<int, string[]> (2, new string[]{ "s", "Warp" })
                    }
            }},
            #endregion
            #region 11: TGJ
            { 11, new Map_Effect_Data { image = new KeyValuePair<string, int>("TGJTrans", 1),//wark
                animation_data = new List<KeyValuePair<int[], int>>
                    {
                        new KeyValuePair<int[], int>(new int[] { 0, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 1, 255, 255 }, 2),
                        ...
                        new KeyValuePair<int[], int>(new int[] { 17, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 18, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 19, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 20, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 21, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 22, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 23, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 24, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 25, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 26, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 27, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 28, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 29, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 30, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 31, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 32, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 33, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 34, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 35, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 36, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 37, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 38, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 39, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 40, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 41, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 42, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 43, 255, 255 }, 2),
                        new KeyValuePair<int[], int>(new int[] { 44, 255, 255 }, 2)
                    },
                    processing_data = new List<KeyValuePair<int,string[]>>
                    {
                        new KeyValuePair<int, string[]> (9, new string[]{ "s", "TGJTrans" })
                    }
            }},
            #endregion
            #region 15: Torch
