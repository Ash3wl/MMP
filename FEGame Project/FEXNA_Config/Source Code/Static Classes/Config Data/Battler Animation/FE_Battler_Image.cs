...
namespace FEXNA
{
    public class FE_Battler_Image
    {
                ...
                //case 91:
                    ...
                    if (battler.Astra_Activated)
                    {
                        if (battler.Astra_Missed)
                            ...
                            {
                                case 5:
                                    return offset.list_add(new List<int>() { 17 });
                                case 4:
                                    return offset.list_add(new List<int>() { 19 });
                                case 3:
                    ...
                    break;
                case 52: //assassin
                    if (battler.Adept_Activated)
                        return offset.list_add(new List<int>() { 15 });
                    break;
                case 91:
                    if (battler.Adept_Activated && battler.Distance==1)
                    {
                        if (battler.Astraaa_Activated)
                        {
                            if (crit)
                                return offset.list_add(new List<int>() { 17, 44 });
                            else
                                return offset.list_add(new List<int>() { 17, 41 });
                        }
                        else
                            return offset.list_add(new List<int>() { crit? 12 : 8 });
                    }
                    break;
                #endregion
            }
            ...
            switch (battler.Class_Id)
            {
                ...
                case 51:
                    ...
                    if (battler.Astra_Activated && battler.Astra_Count > 0)
                    {
                        ...
                        {
                            case 5:
                                return offset.list_add(new List<int>() { 18 });
                            case 4:
                                return offset.list_add(new List<int>() { 20 });
                            case 3:
                                return offset.list_add(new List<int>() {  22 });
                            case 2:
                                return offset.list_add(new List<int>() { 24 });
                            default:
                                return offset.list_add(new List<int>() { 26 });
                        }
                    }
                    break;
                case 52: //heretic
                    if (battler.Adept_Activated)
                        return offset.list_add(new List<int>() { 16 });
                    break;
                case 91:
                    if (battler.Adept_Activated && battler.Distance == 1)
                    {
                        if (battler.Astraaa_Activated)
                            return offset.list_add(new List<int>() { crit? 45 : 42});
                        else
                            return offset.list_add(new List<int>() { crit ? 13 : 9 });
                    }
                    break;
                #endregion
            }
                ...
                case 51:
                    ...
                    if (battler.Astra_Activated && battler.Astra_Count > 0)
                    {
                        switch (battler.Astra_Count)
                        {
                            ...
                            case 3:
                                return offset.list_add(new List<int>() { 36 });
                            case 2:
                                return offset.list_add(new List<int>() { 37 });
                            default:
                                return offset.list_add(new List<int>() { 38 });
                        }
                    }
                    break;
                //case 52: //assassin
                ...
                case 91:
                    if (battler.Adept_Activated && battler.Distance == 1)
                    {
                        if (battler.Astraaa_Activated)
                            ...
                            return offset.list_add(new List<int>() { crit ? 14 : 10 });
                    }
                    break;
                #endregion
            }
        ...
        public static List<int> pre_battle_animation_value(Animation_Setup_Data battler, int offset)
        {
            ...
            switch (battler.Class_Id)
            {
                ...
                #endregion
                case 123: 
                    return offset.list_add(new List<int> { 5 });
                    break;
            }
        ...
        /// </summary>
        public static List<int> spell_attack_animation_value(int weapon_id, int offset, int distance, bool hit)
        {
            switch (weapon_id)
            {
                case 211:
                    return offset.list_add(new List<int>() { 291, 292 });
                case 216:
                    return offset.list_add(new List<int>() { 141 });
                case 201: // Runesword
                    return offset.list_add(distance == 1 ? new List<int>() { 12 } : new List<int>() { 13 });
                case 105:
                    return offset.list_add(new List<int>() { 26, 27 });
                case 18: // Runesword
                    return offset.list_add(distance == 1 ? new List<int>() { 360 } : new List<int>() { 361 });
                case 101: // Fire
                ...
                case 119:
                    return offset.list_add(new List<int>() { 77 });
                case 121: // Wind
                ...
                case 123: // Arcwind
                    return offset.list_add(new List<int>() { 136 });//return offset.list_add(new List<int>() { distance == 1 ? 131 : 126, hit ? 127 : 128 }); //Yeti
                case 12: // Light Brand
                    return offset.list_add(distance == 1 ? new List<int>() { 183 } : new List<int>() { 181 });
                case 131: // Lightning
                case 210:
                    return offset.list_add(new List<int>() { 201 });
                case 132: // Shine
                    return offset.list_add(new List<int>() { 204 });
                case 133: // Divine
                ...
                case 224:
                    return offset.list_add(new List<int>() { 371, 372, 373, 374 });
            }
            return new List<int>();
        }
        ...
        /// </summary>
        public static List<int> spell_attack_animation_value_bg1(int weapon_id, int offset, int distance, bool hit)
        {
            switch (weapon_id)
            {
                case 113: // Arcthunder
        ...
        /// </summary>
        public static List<int> spell_attack_animation_value_bg2(int weapon_id, int offset, int distance, bool hit)
        {
            switch (weapon_id)
            {
                // Luce lol //Yeti
        ...
        /// </summary>
        public static List<int> spell_attack_animation_value_fg(int weapon_id, int offset, int distance, bool hit)
        {
            switch (weapon_id)
            {
                case 115: // Bolting
        ...
        /// </summary>
        public static List<int> spell_end_animation_value(int weapon_id, int offset, bool hit)
        {
            switch (weapon_id)
            {
                case 211:
                    return offset.list_add(new List<int>() { 293 });
                case 216:
                    return offset.list_add(new List<int>() { 142 });
                case 201: // Runesword
                    return offset.list_add(new List<int>() { 14 });
                case 105:
                    return offset.list_add(new List<int>() { 28 });
                case 18: // Runesword
                    return offset.list_add(hit ? new List<int>() { 362 } : new List<int>() { 362, 366 });
                case 27: // Bolt Knife
                ...
                case 119:
                    return offset.list_add(new List<int>() { 78 });
                case 121: // Wind
                ...
                case 123: // Arcwind
                    return offset.list_add(new List<int>() { 137 });//return offset.list_add(hit ? new List<int>() { 129 } : new List<int>() { 130 }); //Yeti
                case 12: // Light Brand
                    return offset.list_add(new List<int>() { 182 });
                case 131: // Lightning
                    return offset.list_add(new List<int>() { 202 });
                case 210:
                    return offset.list_add(new List<int>() { 203 });
                case 132: // Shine
                    return offset.list_add(new List<int>() { 205 });
                case 133: // Divine
                ...
                case 224:
                    return offset.list_add(new List<int>() { 375 });
            }
            return new List<int>();
        }
        ...
        /// </summary>
        public static List<int> spell_lifedrain_animation_value(int weapon_id, int offset, int distance)
        {
            switch (weapon_id)
            {
                case 18: // Runesword
                    return offset.list_add(new List<int>() { distance == 1 ? 363 : 364 });
                case 134: // Resire
        ...
        /// </summary>
        public static List<int> spell_lifedrain_end_animation_value(int weapon_id, int offset)
        {
            switch (weapon_id)
            {
                case 18: // Runesword
                    return offset.list_add(new List<int>() { 365 });
                case 134: // Resire
        ...
        public readonly static int[] Single_Gender_Battle_Sprite = new int[] { 22, 23, 34, 60, 61, 72, 73 };
    ...
    public class Animation_Setup_Data
    {
        ...
        public bool Adept_Activated { get; protected set; }
        public bool Astraaa_Activated { get; protected set; }
        public int Adept_Count { get; protected set; }
    }
