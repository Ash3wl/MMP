                    ...
                    switch (name)
                    {
                        case "Vaida":
                            switch (color)
                            {
                                ...
                                case 4: return new Color(56, 104, 224); // Armor
                    ...
                    switch (name)
                    {
                        case "Fargus":
                            switch (color)
                            {
                                ...
                                case 4: return new Color(136, 112, 120); // Axe
                                case 5: return new Color(176, 160, 160);
                                case 6: return new Color(224, 208, 200);
                            }
                            break;
                        case "Ilia":
                            switch (color)
                            {
                                ...
                                case 2: return COUNTRY_COLORS[name][Color_Keys.Main6];
                                case 3: return COUNTRY_COLORS[name][Color_Keys.Main7];
                                case 4: return new Color(112, 144, 176);
                                case 5: return new Color(152, 184, 216);
                                case 6: return new Color(192, 224, 232);
                            }
                            break;
                        default:
                            if (COUNTRY_COLORS.ContainsKey(name))
                    ...
                    switch (name)
                    {
                        case "Vaida":
                            switch (color)
                            {
                                ...
                                case 7: return new Color(184, 136, 112); // Metal
                                case 8: return new Color(216, 192, 160);
                                case 9: return new Color(240, 232, 224);
