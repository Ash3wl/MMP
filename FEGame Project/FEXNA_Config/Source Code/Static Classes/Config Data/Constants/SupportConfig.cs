...
namespace FEXNA.Constants
{
    public class Support
    {
        ...
        public const int SUPPORT_TOTAL = 15;
        ...
        public readonly static string[] SUPPORT_LETTERS = new string[] { "-", "C", "B", "A", "S" , "SS" };
        public const int MAX_SUPPORT_LEVEL = 5;
            ...
            new Dictionary<Affinities, List<Stat_Labels>[]>
        {
            ...
            { Affinities.Anima, new List<Stat_Labels>[] {
                ...
                new List<Stat_Labels> { Stat_Labels.Skl, Stat_Labels.Res } } },
            { Affinities.Earth, new List<Stat_Labels>[] {
                new List<Stat_Labels> { Stat_Labels.Pow, Stat_Labels.Def },
            ...
            { Affinities.Light, new List<Stat_Labels>[] {
                new List<Stat_Labels> { Stat_Labels.Lck, Stat_Labels.Res },
                new List<Stat_Labels> { Stat_Labels.Pow, Stat_Labels.Def } } },
